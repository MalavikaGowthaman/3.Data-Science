...
#             descriptive.loc['Mean', columnname] = dataset[columnname].mean()
    ...
    def to_check_outliers(Quan,descriptive):
        lesser=[]
        greater=[]
...
#     def to_replace_outlier(dataset, descriptive, lesser, greater):
#         for columnname in lesser:
#             dataset.loc[dataset[columnname] < descriptive.loc["Lesser Outlier", columnname], columnname] = descriptive.loc["Lesser Outlier", columnname]
#         for columnname in greater:
#             dataset.loc[dataset[columnname] > descriptive.loc["Greater Outlier", columnname], columnname] = descriptive.loc["Greater Outlier", columnname]
#         return dataset
